...
const AboutPreview = () => {
  const features = [
    {
      icon: <FaBullhorn />,
      title: "Marketing",
      desc: "Strategic campaigns that grow your brand and drive measurable engagement.",
    },
    {
      icon: <FaPalette />,
      title: "Designing",
      desc: "Immersive visual design that tells your story and captivates your audience.",
    },
    {
      icon: <FaCode />,
      title: "Development",
      desc: "Scalable, modern web & app solutions built with precision and performance.",
    },
    {
      icon: <FaRocket />,
      title: "Startup Consultancy",
      desc: "Helping entrepreneurs turn ideas into impactful, profitable products.",
    },
  ];
  ...
  const whyUs = [
    {
      ...
      desc: "We believe in building partnerships, not just delivering projects.",
    },
    {
      icon: <FaAward />,
      title: "Proven Expertise",
      desc: "Years of experience blending creativity, code, and strategy seamlessly.",
    },
    {
      icon: <FaUsers />,
      title: "Dedicated Team",
      desc: "A passionate, multidisciplinary team driven by innovation and results.",
    },
  ];
  ...
  return (
    <section
      id="about"
      className="relative py-24 bg-gradient-to-b from-black via-black to-gray-950 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          we don’t just design - we build experiences. We help brands stand tall
          in the digital era by combining design brilliance, technical
        ...
        >
          From startups finding their voice to enterprises redefining their
          identity, we deliver solutions that resonate, inspire, and perform.
        </motion.p>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6 mb-2"
        >
